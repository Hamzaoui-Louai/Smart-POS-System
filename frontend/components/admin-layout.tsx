...
import { User, LogOut, Bell, ChevronDown, Users, BarChart3 } from "lucide-react"
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              {/* Admin Badge */}
              <Badge className="bg-gradient-to-r from-blue-600 to-teal-500 text-white">Admin</Badge>
