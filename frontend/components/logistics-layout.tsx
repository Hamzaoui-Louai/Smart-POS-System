...
import { User, LogOut, Bell, ChevronDown, Truck, BarChart3, ClipboardList } from "lucide-react"
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              {/* Logistics Badge */}
              <Badge className="bg-gradient-to-r from-purple-600 to-blue-500 text-white">Logistics</Badge>
