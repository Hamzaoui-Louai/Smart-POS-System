...
import { User, LogOut, Bell, ChevronDown, Package, BarChart3, ShoppingCart, Truck } from "lucide-react"
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              {/* Supplier Badge */}
              <Badge className="bg-gradient-to-r from-green-600 to-teal-500 text-white">Supplier</Badge>
