...
import { Eye, EyeOff, Save, Trash2, AlertTriangle, Store, Building } from "lucide-react"
...
export default function PharmacyOwnerPersonalInformationPage() {
  ...
  const [personalInfo, setPersonalInfo] = useState({
    ...
    taxId: "98-7654321",
    operatingHours: "Mon-Sat: 8AM-10PM, Sun: 9AM-8PM",
  })
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card className="border-red-200 shadow-lg animate-slide-up" style={{ animationDelay: "200ms" }}>
          <CardHeader>
            ...
            <p className="text-sm text-gray-600">Actions that will permanently affect your pharmacy account</p>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-between p-4 bg-red-50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Permanently delete your pharmacy account and all associated data including inventory and sales records
                </p>
              </div>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      ...
                      inventory data, sales records, and cancel any pending orders.
                    </DialogDescription>
                  </DialogHeader>
                  <div className="py-4">
