        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
            <CardHeader>
              ...
              <CardTitle className="font-heading text-xl">Secure & Private</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
            <CardHeader>
              ...
              <CardTitle className="font-heading text-xl">Medication History</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600">
                Keep track of all your prescriptions and medication history in one convenient place.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
            <CardHeader>
              ...
              <CardTitle className="font-heading text-xl">Smart Notifications</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600">
                Receive timely alerts for refills, discounts, and important medication reminders.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
            <CardHeader>
              ...
              <CardTitle className="font-heading text-xl">Trusted Network</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600">
                Access a network of verified pharmacies and healthcare providers in your area.
              </p>
            </CardContent>
          </Card>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Check medicine availability across multiple pharmacies in real-time.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Compare prices across different pharmacies to find the best deals.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Prescription Management</h3>
                  <p className="text-gray-600">Upload and manage your prescriptions digitally with ease.</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Track your medication deliveries from pharmacy to your doorstep.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Gain insights into your medication patterns and health trends.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Insurance Integration</h3>
                  <p className="text-gray-600">Seamlessly integrate with your insurance provider for easy claims.</p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-1">support@pharmasphere.com</p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-1">123 Healthcare Ave, Suite 100</p>
