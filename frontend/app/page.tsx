          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="font-heading text-xl">Find Nearby Pharmacies</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Locate trusted pharmacies in your area with real-time availability and ratings.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader>
                ...
                <CardTitle className="font-heading text-xl">Track Your History</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Keep detailed records of your medications and prescriptions in one secure place.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">Get alerts for refills, discounts, and important medication reminders.</p>
              </CardContent>
            </Card>
          </div>
        </div>
          ...
          <div className="animate-fade-in">
            ...
            <div className="space-y-4">
              {nearbyPharmacies.map((pharmacy, index) => (
                <Card key={index} className="card-shadow hover:shadow-md transition-all duration-200">
